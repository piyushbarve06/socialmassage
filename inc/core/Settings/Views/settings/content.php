<div class="container my-5">
    <div class="card card-flush">
        <div class="card-header mt-6">
            <div class="card-title flex-column">
                <h3 class="fw-bolder"><i class="fad fa-browser dashboard-icon me-3"></i> <?php _e('Website info')?></h3>
            </div>
        </div>
        <div class="card-body">
            <div class="mb-4">
    ...
    <div class="m-t-25">
        <div class="card card-flush">
            <div class="card-header mt-6">
                <div class="card-title flex-column">
                    <h3 class="fw-bolder"><i class="fad fa-calendar-alt dashboard-icon me-3"></i> <?php _e('Date and Time Formats')?></h3>
                </div>
            </div>
            <div class="card-body">
                <div class="mb-3">
