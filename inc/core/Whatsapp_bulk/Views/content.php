    ...
    <div class="">
        <div class="dropdown me-2">
            <div class="input-group input-group-sm sp-input-group border b-r-4">
                ...
                <a href="<?php _ec( get_module_url('popup_report') )?>" class="btn btn-active-light-success actionItem"  data-popup="ReportBulkModal" title="<?php _e("Report")?>" data-toggle="tooltip" data-placement="top"><i class="fad fa-file-chart-line dashboard-icon"></i></a>
            </div>
        </div>
    </div>
</div>
