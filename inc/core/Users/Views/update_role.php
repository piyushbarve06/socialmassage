                        ...
                        <?php if (!empty($rows)): ?>
                            ...
                            <div class="tab-pane fade <?php _ec( ($count == 0)?"active show":"" ) ?>" id="role_<?php _ec($rows[0]['id'])?>" role="tabpanel">
                                ...
                                <div class="border border-dashed border-gray-300 rounded p-20 mb-4">
                                    <h5 class="fw-bold m-b-30"><i class="<?php _ec( $rows[0]['icon'] )?>" style="color: #FF5B35"></i> <?php _ec( $rows[0]['name'] )?></h5>
                                    <div class="mb-3">
                                ...
                                <div class="border border-dashed border-gray-300 rounded p-20 mb-4">
                                    <h5 class="fw-bold m-b-30"><i class="<?php _ec( $icon )?>" style="color: #FF5B35"></i> <?php _ec( $name )?></h5>
                                    <div class="mb-3">
                                        <label for="website_description" class="form-label"> 
                                            <div class="form-check form-check-inline">
                                                <input 
