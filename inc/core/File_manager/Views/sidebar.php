    ...
    <div class="fm-options">
        ...
        <div class="mb-4">
            ...
            <div class="fm-box-upload-by-url">
                <div class="input-group mb-3">
                    <input type="text" class="form-control fs-12 fm-input-upload-by-url" name="upload_by_url" placeholder="<?php _e("Enter file url")?>" >
    ...
    <div class="fm-storage mb-3">
        ...
        <div class="d-flex justify-content-between mb-2">
            ...
            <div class="text-end text-gray-800">
                <div class="fw-6 fs-18 total"><?php _e( sprintf(__("%dMB"), $max_storage) )?></div>
    ...
    <div class="fm-stats">
        ...
        <div class="d-flex align-items-center mb-3">
            ...
            <div class="flex-fill text-gray-700">
                ...
                <div class="fs-10 text-muted"><?php _e( sprintf(__("%d files"), $media_info['video']['count'])  )?></div>
            </div>
