	...
	<div class="card mb-4">
		<div class="card-header border-0 pt-3">
			<h3 class="card-title align-items-start flex-column">
				<span class="card-label fw-bold text-dark"><i class="<?php _ec( $config['icon'] )?>" style="color: #FF5C35"></i> <?php _e( $config['name'] )?></span>
			</h3>
		</div>
			...
			<div class="m-b-25">
                <div class="input-group input-group-solid">
                    ...
                    <a 
                    	...
                    	href="<?php _e( base_url('whatsapp_profiles/delete') )?>" 
