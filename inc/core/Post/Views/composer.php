...
<div class="container">
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="row post-type d-none">
				<label class="col-4 bg-primary text-light-primary" for="type_media" id="media">
				...
				<label class="col-4" for="type_link" id="link">
					<div class="d-block d-md-flex d-sm-flex text-center align-items-center flex-row-fluid flex-wrap">
				...
				<label class="col-4" for="type_text" id="text">
					<div class="d-block d-md-flex d-sm-flex text-center align-items-center flex-row-fluid flex-wrap">
		...
		<div id="media-content"  class="post-tab filemanager-tab col-md-4">
			<?php echo view_cell('\Core\File_manager\Controllers\File_manager::widget') ?>
		</div>
		<div id="link-content" class="post-tab post-content-tab col-md-4">
			<div class="card border h-100 post-schedule wrap-caption">
				...
				<div class="card-body p-20 position-relative">
					<div class="mb-3">
						<?php echo view_cell('\Core\Account_manager\Controllers\Account_manager::widgetsidebar', ["account_id" => get_data($post, 'account_id'), "module_permission" => "%s_post"]) ?>
					</div>
					...
					<?php echo view_cell('\Core\Caption\Controllers\Caption::block', ['name' => 'caption', 'value' => $caption]) ?>
		...
		<div id="text-content" class="post-tab preview-tab col-md-4">
			<?php if(!empty($frame_posts)){?>
