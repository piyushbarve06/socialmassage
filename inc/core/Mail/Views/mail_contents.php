			...
			<form class="actionForm" action="<?php _ec( get_module_url("role_save") )?>" method="POST" data-redirect="<?php _ec( get_module_url("index/role") )?>">
				<div class="card">
					<div class="card-header">
						<div class="card-title"><i class="fad fa-align-center fs-18 text-success me-3"></i>  <?php _e("Email contents");?></div>
					</div>
...
<script type="text/javascript">
	$(function(){
		Core.ckeditor("activation_email_content", {"convert_urls": false});
		Core.ckeditor("welcome_email_content", {"convert_urls": false});
		Core.ckeditor("email_forgot_password_content", {"convert_urls": false});
		Core.ckeditor("renewal_reminders_email_content", {"convert_urls": false});
		Core.ckeditor("payment_success_email_content", {"convert_urls": false});
	});
</script>