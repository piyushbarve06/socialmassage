						...
						<div class="card-header px-4 border-0">
							...
							<div class="card-title fw-normal fs-12">
									...
									<div class="d-flex align-items-center flex-row-fluid flex-wrap">
										<div class="flex-grow-1 me-2 text-over-all">
											<a href="<?php _ec( $value->url )?>"  target="_blank" class="text-gray-800 text-hover-primary fs-14 fw-bold">
												<i class="<?php _ec( $value->icon )?>" style="color: <?php _ec( $value->color )?>;"></i> <?php _ec( $value->name )?>
												<?php if ($value->type == "live"): ?>
												<span class="bg-danger b-r-3 px-2 py-0 text-white fs-11"><?php _e("Live");?></span>
												<?php endif ?>
											</a>
						 	...
						 	<div class="card-toolbar">
						 		<?php if ($value->type == "live"): ?>
								<a href="<?php _ec( base_url("livestream?post_id=".$value->ids) )?>" class="btn btn-sm px-3 btn-light-primary me-2">
