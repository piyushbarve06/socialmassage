...
<div class="container my-5">
    <div class="card">
        <div class="card-header mt-6">
            <div class="card-title flex-column">
                <h3 class="fw-bolder"><i class="dashboard-icon me-3 <?php _e( $config['icon'] )?>"></i> <?php _e( "Backend configure" )?></h3>
            </div>
        </div>
        <div class="card-body">
            <div class="mb-4">
    ...
    <div class="m-t-25">
        <div class="card">
            <div class="card-header mt-6">
                <div class="card-title flex-column">
                    <h3 class="fw-bolder"><i class="dashboard-icon me-3 <?php _e( $config['icon'] )?>"></i> <?php _e('Frontend themes')?></h3>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card b-r-6 border ">
                            ...
                            <div class="card-footer d-flex justify-content-between align-items-center px-3 py-3">
                                ...
                                <?php if ( get_option("frontend_template", "Stacklight") == $value['id'] ): ?>
