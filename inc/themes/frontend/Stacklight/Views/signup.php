                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" name="fullname" value="" class="form-control" placeholder="<?php _e("Fullname")?>">
                                            </div>
                                        </div>
                                    </div>
									<div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" name="username" value="" class="form-control" placeholder="<?php _e("Username")?>">
                                            </div>
                                        </div>
                                    </div>
									<div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" name="email" value="" class="form-control" placeholder="<?php _e("Email")?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input id="show-hide-password" name="password" type="password" class="form-control" value="" placeholder="<?php _e("Password")?>">
                                            </div>
                                        </div>
                                    </div>
									<div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input id="show-hide-password" name="confirm_password" type="password" class="form-control" value="" placeholder="<?php _e("Confirm Password")?>">
                                            </div>
                                        </div>
                                    </div>
